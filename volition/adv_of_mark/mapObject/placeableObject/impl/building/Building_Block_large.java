...
public class Building_Block_large extends PlaceableObject {
    ...
    public Building_Block_large(double x, double y) {
        super(loadImage(), ObjectEvent.NONE, "Suspiciously large.", "What could they possibly store in there?", true, x, y, Tile.TILE_SIZE, Tile.TILE_SIZE, Tile.TILE_SIZE);
    }

    public static BufferedImage loadImage(){
        if (image == null)
            image = ImageManager.getInstance().loadImage("/volition/adv_of_mark/assets/image/objects/buildings/building_block_large.png");

...
import me.lvgen.util.FileManager;
...
public class LvGen_Window {
    ...
    private void createToolbar(){
        ...
        save.addActionListener(e -> {
            FileManager.getInstance().save("LVGEN_lv.txt", LvGen_Main.getInstance().getMap());
        });
        toolBar.add(save);
        ...
        open.addActionListener(e -> {
            LvGen_Main.getInstance().setMap(FileManager.getInstance().open("/Users/mccloskeybr/IdeaProjects/GIT/The-Adventures-of-Mark/LVGEN_lv.txt"));
        });
        toolBar.add(open);
        toolBar.addSeparator();
    ...
    private void createTileSelectMenu(){
        ...
        HashMap<Integer, BufferedImage> idMap = TileManager.getInstance().getIdMap();

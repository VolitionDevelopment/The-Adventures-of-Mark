...
public class PizzaSlice extends Usable {
    public PizzaSlice() {
        super("Single Slice", "A delicious single slice of pizza.",  "Heals 25 Tolerance.", 15, 25, ImageManager.getInstance().loadImage("/me/volition/assets/image/items/usables/slicepizza.png"));
    }
